...
namespace NBitcoin
{
    ...
    public class TxObj : IBitcoinSerializable, IDestination
    {
        private Script publicKey = Script.Empty;
        public Script ScriptPubKey
        {
        ...
        public TxObj(Money value, IDestination destination)
        {
            this.Value = value;
            if (destination != null) this.ScriptPubKey = destination.ScriptPubKey;
        }

        public TxObj(Money value, Script scriptPubKey)
        {
            this.Value = value;
            this.ScriptPubKey = scriptPubKey;
        }
        ...
        public static TxObj Parse(string hex)
        {
            var ret = new TxObj();
            ret.FromBytes(Encoders.Hex.DecodeData(hex));
            return ret;
    ...
    public class TxObjList : UnsignedList<TxObj>
    {
        ...
        public TxObjList(Transaction parent)
            : base(parent)
        {

        }
        public IEnumerable<TxObj> To(IDestination destination)
        {
            return this.Where(r => r.IsTo(destination));
        }
        public IEnumerable<TxObj> To(Script scriptPubKey)
        {
            return this.Where(r => r.ScriptPubKey == scriptPubKey);
        }
